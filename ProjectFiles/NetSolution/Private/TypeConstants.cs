...
namespace ProjectCreatedWithVersion_1_2_LL
{
    public static class ObjectTypes
    {
        private static readonly int namespaceIndex = NamespaceMapProvider.GetNamespaceIndex("ProjectCreatedWithVersion_1_2_LL");
        public static readonly NodeId EditUserDetailPanel = new NodeId(namespaceIndex, new Guid("5bd1738d3f60d47ba30b9df411fa0050"));
        public static readonly NodeId MainWindow = new NodeId(namespaceIndex, new Guid("bb3ffd2e45ccdf85b7f023208754721d"));
        public static readonly NodeId AnalogAlarmGrid = new NodeId(namespaceIndex, new Guid("37442aa2bd8928c465725a9d655a4f8f"));
        public static readonly NodeId LoginDialog_中é = new NodeId(namespaceIndex, new Guid("4623a914f03a278dcfdb69f30e5122d9"));
        public static readonly NodeId CreateUserPanel = new NodeId(namespaceIndex, new Guid("76c6b9dc24666b9297ce397d3fb2b9fe"));
        public static readonly NodeId 报警网格 = new NodeId(namespaceIndex, new Guid("71cef6cb9448ed8eec272a74a2aac225"));
        public static readonly NodeId RecipesEditor = new NodeId(namespaceIndex, new Guid("d8c1f937b06701ef258bf0ca9bebb5a9"));
        public static readonly NodeId User_Editor_Panel_中é = new NodeId(namespaceIndex, new Guid("a595e6d9267daf5b97d9114159b29575"));
        public static readonly NodeId Alarm_Grid_Panel_中é = new NodeId(namespaceIndex, new Guid("469b7710941a259b265c5f8e91994f67"));
        public static readonly NodeId Recipes_Editor_Panel_中é = new NodeId(namespaceIndex, new Guid("1b61db0c3d363c14fced133a95fcac86"));
        public static readonly NodeId ChangeUserDialog = new NodeId(namespaceIndex, new Guid("f656335c0d3d60f9b6d555dd2a9a0223"));
